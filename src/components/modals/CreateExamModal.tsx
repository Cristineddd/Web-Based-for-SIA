              ...
              <label className="block space-y-1.5">
                ...
                {!formData.name.trim() && (
                  <p className="text-xs text-gray-400">
                    Try "Math Midterm", "Science Quiz 1", or "Final Exam"
                  </p>
                )}
              </label>
              {isDuplicate && (
                <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  ...
                  <div className="text-xs text-amber-800">
                    ...
                    <p className="mt-0.5">
                      An exam with this name already exists. You can still
                      proceed.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  {
                    label: "A, B, C, D",
                    sub: "4 Choices (Most Common)",
                    value: 4,
                  },
                  {
                    label: "A, B, C, D, E",
                    sub: "5 Choices (Extended)",
                    value: 5,
                  },
                ].map((opt) => (
                  <button
              ...
              <p className="text-xs text-green-700 font-medium">
                {formData.choicesPerItem} answer choices selected
              </p>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    key={opt.value}
                    onClick={() => {
                      handleInputChange("examType", opt.value);
                  ...
                  >
                    <div
                      className={`font-semibold text-sm ${formData.examType === opt.value && examTypePicked ? "text-green-700" : "text-gray-800"}`}
                    >
                      {opt.label}
                    </div>
                    <div className="text-xs text-gray-400 mt-0.5">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-2">
                ...
                {[
                  ...
                  {
                    label: "Questions",
                    value: `${formData.totalQuestions} questions`,
                  },
                  {
                    label: "Answer Format",
                    value: `${formData.choicesPerItem} choices per question`,
                  },
