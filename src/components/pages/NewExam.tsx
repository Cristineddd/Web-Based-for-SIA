  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 2) {
      ...
      if (formData.student_id_length < 4 || formData.student_id_length > 12) {
        newErrors.student_id_length =
          "Student ID length must be between 4 and 12";
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const examData = {
        ...
        folder:
          classes.find((c) => c.id === formData.classId)?.course_subject || "",
      ...
      <div className="mb-4">
        ...
        <div className="mt-2 space-y-1">
          ...
          <div className="text-sm text-blue-600 font-medium">
            {currentStep === 1 &&
              "📝 Let's start with the basic exam information"}
          ...
          {Object.keys(errors).length === 0 && currentStep < steps.length && (
            <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2 text-green-800">
                ...
                <span className="font-medium">
                  ✅ Step {currentStep} looks good! Ready to continue.
                </span>
              </div>
            </div>
          )}
              ...
              <div className="space-y-3">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-2">
                  ...
                  <p className="text-sm text-blue-600">
                    Fill in the essential details about your exam. Make sure to
                    choose the correct class and subject.
                  </p>
                </div>
              ...
              <div className="space-y-2">
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-2">
                  <h3 className="font-medium text-orange-900 mb-2">
                    ⚙️ Step 2: Exam Configuration
                  </h3>
                  <p className="text-sm text-orange-700">
                    Configure the format and structure of your exam. These
                    settings affect how answer sheets are generated.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    📝 Choose a preset or enter a custom number of questions for
                    your exam.
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`max-w-xs ${
                        errors.num_items
                          ? "border-red-500 focus:border-red-500 focus:ring-red-200"
                          : formData.num_items >= 1 && formData.num_items <= 200
                            ? "border-green-500 focus:border-green-500 focus:ring-green-200"
                            : ""
                      }`}
                    />
                  </div>
                  {formData.num_items >= 1 &&
                    formData.num_items <= 200 &&
                    !errors.num_items && (
                      <p className="text-xs text-green-600 flex items-center gap-1">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    🔤 Select how many answer choices each question will have.
                    Most common is 4 choices (A, B, C, D).
                  </p>
                  <div className="grid grid-cols-2 gap-2">
                    {[2, 3, 4, 5].map((num) => (
                      ...
                      >
                        ...
                        <div className="text-xs opacity-75">{num} choices</div>
                      </button>
                    ))}
                  </div>
                  {formData.choices_per_item >= 2 &&
                    formData.choices_per_item <= 6 &&
                    !errors.choices_per_item && (
                      <p className="text-xs text-green-600 flex items-center gap-1">
                        ✅ {formData.choices_per_item} answer choices per
                        question
                      </p>
                    )}
                  {errors.choices_per_item && (
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    🎦 How many digits should student IDs have on the answer
                    sheet? Default is 9 digits.
                  </p>
                  <div className="flex items-center gap-4">
                    <Input
                      ...
                      className={`w-32 ${
                        errors.student_id_length
                          ? "border-red-500 focus:border-red-500 focus:ring-red-200"
                          : formData.student_id_length >= 4 &&
                              formData.student_id_length <= 12
                            ? "border-green-500 focus:border-green-500 focus:ring-green-200"
                            : ""
                      }`}
                    />
                    <div className="text-sm text-gray-600">
                      digits (e.g.,{" "}
                      {"0"
                        .repeat(formData.student_id_length)
                        .replace(/0/g, "#")}
                      )
                    </div>
                  </div>
              ...
              <div className="space-y-2">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-green-700">
                    Review all your exam settings below. You can add an optional
                    description and then create your exam.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">
                          {formData.className || "Not selected"}
                        </span>
                      </div>
                      {/* Subject / Folder removed */}
                      <div className="flex justify-between">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">
                          {formData.choices_per_item} (
                          {Array.from(
                            { length: formData.choices_per_item },
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">
                          {formData.student_id_length} digits
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Description:</span>
                        <span className="font-medium text-gray-900">
                          {formData.description.trim() ? "Added" : "None"}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-blue-200">
                    <div className="text-center text-sm text-blue-700">
                      🚀 <strong>Ready to create your exam!</strong> Once
                      created, you can add answer keys and start scanning
                      papers.
                    </div>
                  </div>
                </div>
                ...
                <Button
                  ...
                  onClick={() => {
                    if (validateStep(currentStep)) {
                      ...
                      toast.error(
                        `Please complete all required fields in ${steps[currentStep - 1].title}`,
                      );
                    }
                  }}
